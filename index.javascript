...
function iniciarJuego() {
    ...
    if (!canvas) {
        mostrarError("No se encontró el canvas #game.");
        return;
    }
    ...
    if (!ctx) {
        mostrarError("No se pudo iniciar el motor gráfico.");
        return;
    }
    ...
    if (
        ...
        mostrarError("Faltan elementos del HUD en index.html.");
        return;
    }
    ...
    function mostrarError(texto) {
        ...
        console.error("ERROR DEL JUEGO:", texto);

        const mensaje =
            document.getElementById("mensaje");

        const error =
            document.getElementById("errorJuego");
    ...
    function actualizarHUD() {
        ...
        vidaHTML.textContent =
            jugador.vida;

        monedasHTML.textContent =
            totalMonedas;

        nivelHTML.textContent =
            nivel;

        oleadaHTML.textContent =
            oleada;
